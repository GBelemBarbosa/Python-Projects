...
class CharacterSheetWindow(ctk.CTkToplevel):
    ...
    def _update_portrait_display(self):
        ...
        self.portrait_label.configure(image=None, text="📷\nPortrait")
    ...
    def create_shards_section(self):
        ...
        ctk.CTkLabel(cl_frame, text="Caster Level:", font=("Roboto", 12), text_color="gray90").pack(side="left", padx=self.p)
        self.caster_level_var = StringVar(value="0")
        ...
        res_header.pack(anchor="w", padx=(self.p, 0))
    ...
    def _prompt_hit_dice(self):
        ...
        for die, count in available.items():
            ...
            ctk.CTkButton(sub, text="-", width=20, height=24, fg_color="gray30", hover_color="gray35",
                          border_width=2, border_color=self.color,
    ...
    def create_rest_section(self):
        ...
        for i, (txt, cmd) in enumerate(btns):
            ...
            ctk.CTkButton(content, text=txt, font=("Roboto", 12),
                          ...
                          border_width=2, border_color=self.color,
                          width=90, height=28, command=cmd).grid(row=0, column=i, padx=(0, self.p if i < 3 else 0), pady=(self.p, 0), sticky="ew")
    ...
    def create_spell_tracking_section(self):
        ...
        ctk.CTkLabel(self.spell_tracking_header_frame, text="Current", font=("Roboto", 12), width=80, anchor="center").grid(row=0, column=1, padx=(self.p, 0))
        ctk.CTkLabel(self.spell_tracking_header_frame, text="/", font=("Roboto", 12), width=10, anchor="center").grid(row=0, column=2)
        ctk.CTkLabel(self.spell_tracking_header_frame, text="Max", font=("Roboto", 12), width=40, anchor="center").grid(row=0, column=3, padx=(0, self.p))
    ...
    def _import_monster_stat_block_popup(self):
        ...
        ctk.CTkButton(top, text="Import", command=do_import,
                      fg_color="gray25", hover_color="gray30", border_color=self.color, border_width=2).pack(pady=self.p)
    ...
    def _create_resonance_grid(self, parent, sat_list, count_list, mult_list, is_pact=False):
        ...
        ctk.CTkLabel(res_grid, text="Output", font=("Roboto", 12),
                     text_color="gray50", width=55, anchor="w").grid(row=0, column=0)
        for i in range(1, 10):
        ...
        ctk.CTkLabel(res_grid, text="Satur.", font=("Roboto", 12),
                     text_color="gray50", width=55, anchor="w").grid(row=1, column=0)
        for i in range(9):
        ...
        ctk.CTkLabel(res_grid, text="Count", font=("Roboto", 12),
                     text_color="gray50", width=55, anchor="w").grid(row=2, column=0)
        for i in range(9):
            ent = ctk.CTkEntry(res_grid, font=("Roboto", 12), width=30, height=20, justify="center",
                               fg_color="gray25", border_width=0)
...
class GUI(ctk.CTk): 
        ...
        def populate_roll_list(self):
            ...
            try:
                ...
                for i, filename in enumerate(files):
                    ...
                    btn.grid(row=i, column=0, pady=(self.rescale, 0), sticky="ew")
        ...
        def layout(self,name):
                ...
                self.allButton = ctk.CTkButton(self,
                                    ...
                                    border_color=self.color,
                                    border_width=2,
                                    fg_color="gray20", hover_color="gray25", font=("Roboto", 12), command = lambda: self.AllClick())
                ...
                self.blocbtt= ctk.CTkButton(self,
                                                    ...
                                                    border_color=self.color,
                                                    border_width=2,
                                                    fg_color="gray20", hover_color="gray25", font=("Roboto", 12), command = lambda: self.blocswitch())
                ...
                self.buttonMsg = ctk.CTkButton(self,
                                                            ...
                                                            border_color=self.color,
                                                            border_width=2,
                                                            fg_color="gray20", hover_color="gray25", font=("Roboto", 12), command = lambda : self.sendButton(self.entryMsg.get()))
                ...
                self.button_block = ctk.CTkButton(self.send_row,
                                                            ...
                                                            border_color=self.color,
                                                            border_width=2,
                                                            fg_color="gray20", hover_color="gray25", font=("Roboto", 12), command = lambda : self.send_block())
                ...
                self.resbtt2 = ctk.CTkButton(self.resourcebar2, 
                                                            ...
                                                            border_color=self.color,
                                                            border_width=2,
                                                            fg_color="gray25", hover_color="gray30", font=("Roboto", 12), command = lambda: self.callbackRes(self.reslabel.get())) 
                ...
                self.resbox = IntSpinbox(self.resourcebar2,
                                    ...
                                    from_ = 0, fg_color="gray30", hover_color="gray35")
                ...
                self.critbox = IntSpinbox(self.resourcebar1,
                                    ...
                                    from_ = 0,
                                    step_size = 10, fg_color="gray30", hover_color="gray35")
                ...
                self.minbox = IntSpinbox(self.resourcebar3,
                                    ...
                                    to_ = 2000,
                                    step_size = 100,
                                    width=112, fg_color="gray30", hover_color="gray35")
                ...
                self.acon = IntSpinbox(self.antebar,
                                        color=self.color, variable = self.ac, fg_color="gray25", hover_color="gray30")
                ...
                self.aadv = IntSpinbox(self.antebar,
                                        color=self.color, variable = self.aa, fg_color="gray25", hover_color="gray30")
                ...
                self.adic = IntSpinbox(self.antebar,
                                    color=self.color, variable = self.ad[0], fg_color="gray25", hover_color="gray30")
                ...
                self.adic2 = IntSpinbox(self.antebar,
                                    ...
                                    from_ = 0, fg_color="gray25", hover_color="gray30")
                ...
                self.icon = IntSpinbox(self.interbar,
                                        color=self.color, variable = self.ic, fg_color="gray25", hover_color="gray30")
                ...
                self.iadv = IntSpinbox(self.interbar,
                                        color=self.color, variable = self.ia, fg_color="gray25", hover_color="gray30")
                ...
                self.idic = IntSpinbox(self.interbar,
                                    color=self.color, variable = self.id[0], fg_color="gray25", hover_color="gray30")
                ...
                self.pcon = IntSpinbox(self.postbar,
                                        color=self.color, variable = self.pc, fg_color="gray25", hover_color="gray30")
                ...
                self.padv = IntSpinbox(self.postbar,
                                        color=self.color, variable = self.pa, fg_color="gray25", hover_color="gray30")
                ...
                self.pdic = IntSpinbox(self.postbar,
                                    color=self.color, variable = self.pd[0], fg_color="gray25", hover_color="gray30")
                ...
                self.pdic2 = IntSpinbox(self.postbar,
                                    color=self.color, variable = self.pd[1], fg_color="gray25", hover_color="gray30",
                                    from_ = 0)
